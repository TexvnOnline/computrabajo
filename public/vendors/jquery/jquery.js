!(function (n, t) {
        ...
        if (1 === t.nodeType) {
            if (r.hasData(n) && (e = r.get(n).events))
                for (f in (r.remove(t, "handle events"), e))
                    for (u = 0, s = e[f].length; u < s; u++)
                        i.event.add(t, f, e[f][u]);
            o.hasData(n) &&
                ((h = o.access(n)), (c = i.extend({}, h)), o.set(t, c));
        }
    }
    function at(n, t, f, o) {
        t = pr(t);
        var a,
            ...
            w = t[0],
            k = u(w);
        if (k || (1 < p && "string" == typeof w && !e.checkClone && we.test(w)))
        ...
        if (
            p &&
            ((b = (a = yu(t, n[0].ownerDocument, !1, n, o)).firstChild),
            1 === a.childNodes.length && (a = b),
            b || o)
        ) {
            for (v = (l = i.map(s(a, "script"), ke)).length; c < p; c++)
                (h = a),
                    c !== d &&
                        ((h = i.clone(h, !0, !0)),
            ...
            if (v)
                for (
                    y = l[l.length - 1].ownerDocument, i.map(l, de), c = 0;
                    c < v;
                    c++
                )
                    (h = l[c]),
                        au.test(h.type || "") &&
                            ...
                            (h.src && "module" !== (h.type || "").toLowerCase()
                                ...
                                : kr(h.textContent.replace(be, ""), h, y));
        }
        return n;
    }
    function bu(n, t, r) {
        ...
        return (
            ...
            (n in nf
                ...
                : (tf[n] =
                      (function (n) {
                          for (
                              var i = n[0].toUpperCase() + n.slice(1),
                                  t = gu.length;
                              t--;
    ...
    function v(n, t, r) {
        ...
        for (
            ...
            if ((o = v.prefilters[h].call(f, n, c, f.opts)))
                return (
                    u(o.stop) &&
                        (i._queueHooks(f.elem, f.opts.queue).stop =
                            o.stop.bind(o)),
                    o
                );
        return (
                ...
                for (f in s)
                    (t = s[f]),
                        "__proto__" !== f &&
                            ...
                            (h &&
                            t &&
                            (i.isPlainObject(t) || (o = Array.isArray(t)))
                                ? ((e = n[f]),
                                  (c =
                                      o && !Array.isArray(e)
                                          ? []
    ...
    i.extend({
        ...
        isPlainObject: function (n) {
            var t, i;
            return (
                !(!n || "[object Object]" !== wr.call(n)) &&
                (!(t = yr(n)) ||
                    ("function" ==
                        typeof (i =
                            ui.call(t, "constructor") && t.constructor) &&
                        br.call(i) === ee))
            );
        },
    ...
    d = (function (n) {
        ...
        function ei(n) {
            for (
                ...
                if ((u = t.relative[n[i].type])) f = [wt(ui(f), u)];
                    ...
                    if (
                        (u = t.filter[n[i].type].apply(null, n[i].matches))[e]
                    ) {
                        for (r = ++i; r < s; r++)
                    ...
                    l != i &&
                        ...
                        (f.scope = a(function (n) {
                            return (
                                ...
                                "undefined" != typeof n.querySelectorAll &&
                                    !n.querySelectorAll(":scope fieldset div")
                                        .length
                            );
                        })),
                        ...
                        (f.getElementsByClassName = ot.test(
                        ...
                        (f.qsa = ot.test(i.querySelectorAll)) &&
                            (a(function (n) {
                                ...
                                n.querySelectorAll("[msallowcapture^='']")
                                    .length &&
                                    o.push("[*^$]=" + r + "*(?:''|\"\")");
                                n.querySelectorAll("[selected]").length ||
                                    o.push("\\[" + r + "*(?:value|" + gt + ")");
                                n.querySelectorAll("[id~=" + e + "-]").length ||
                                    o.push("~=");
                                (t = i.createElement("input")).setAttribute(
                                    "name",
                                    ""
                                );
                                n.appendChild(t);
        ...
        (u.attr = function (n, r) {
            ...
            var e = t.attrHandle[r.toLowerCase()],
                u =
                    e && tr.call(t.attrHandle, r.toLowerCase())
                        ? e(n, r, !h)
                        : void 0;
            return void 0 !== u
                ? u
        ...
        return (
            ...
            (si = u.select =
                function (n, i, r, u) {
                    ...
                    if (((r = r || []), 1 === s.length)) {
                        ...
                        for (
                            o = vt.needsContext.test(n) ? 0 : f.length;
                            o--;
                            ...
                            if (
                                ...
                                (u = a(
                                    e.matches[0].replace(y, p),
                                    (ti.test(f[0].type) && ri(i.parentNode)) ||
                                        i
                                ))
                            ) {
            ...
            (f.sortDetached = a(function (n) {
                return (
                    1 & n.compareDocumentPosition(i.createElement("fieldset"))
                );
            })),
            a(function (n) {
                return (
    ...
    i.fn.extend({
        ...
        is: function (n) {
            return !!bi(
                this,
                "string" == typeof n && nu.test(n) ? i(n) : n || [],
                !1
            ).length;
        },
    });
    ...
    uu = { children: !0, contents: !0, next: !0, prev: !0 };
    i.fn.extend({
        has: function (n) {
            var t = i(n, this),
                r = t.length;
    ...
    i.each(
        {
            ...
            contents: function (n) {
                return null != n.contentDocument && yr(n.contentDocument)
                    ? n.contentDocument
        ...
        function (n, t) {
            i.fn[n] = function (r, u) {
                ...
                return (
                    ...
                    1 < this.length &&
                        (uu[n] || i.uniqueSort(f), ru.test(n) && f.reverse()),
                    this.pushStack(f)
                );
            };
        }
    ...
    i.extend({
        ...
        when: function (n) {
            ...
            if (
                e <= 1 &&
                (eu(n, r.done(s(t)).resolve, r.reject, !e),
    ...
    g.getRootNode &&
        (st = function (n) {
            return (
                ...
                n.getRootNode(ve) === n.ownerDocument
            );
        });
    dt = function (n, t) {
        return (
    ...
    i.event = {
                        ...
                        (a = y.handle) ||
                            (a = y.handle =
                                function (t) {
                                    if (
                                        "undefined" != typeof i &&
                                        i.event.triggered !== t.type
                                    )
                                        return i.event.dispatch.apply(
                                            n,
                                            arguments
                                        );
                                }),
                            ...
                            (h = i.extend(
                                {
                                    ...
                                    selector: e,
                                    needsContext:
                                        e && i.expr.match.needsContext.test(e),
                                    namespace: b.join("."),
                                },
                                p
                            )),
                ...
                for (p = (t = (t || "").match(l) || [""]).length; p--; )
                    if (
                        ...
                        k &&
                            !a.length &&
                            ((h.teardown &&
                                !1 !== h.teardown.call(n, b, w.handle)) ||
        ...
        dispatch: function (n) {
            var u,
                ...
                t = i.event.fix(n),
                a =
                    (r.get(this, "events") || Object.create(null))[t.type] ||
                    [],
                o = i.event.special[t.type] || {};
            for (s[0] = t, u = 1; u < arguments.length; u++)
                s[u] = arguments[u];
            if (
        ...
        handlers: function (n, t) {
            ...
            return (
                (r = this),
                s < t.length && c.push({ elem: r, handlers: t.slice(s) }),
                c
            );
        },
    ...
    i.extend({
        ...
        clone: function (n, t, r) {
            ...
            if (
                ...
                for (f = s(h), u = 0, c = (o = s(n)).length; u < c; u++)
                    (l = o[u]),
                        (a = f[u]),
                        void 0,
                        "input" === (v = a.nodeName.toLowerCase()) &&
                        gt.test(l.type)
                            ? (a.checked = l.checked)
                            : ("input" !== v && "textarea" !== v) ||
            ...
            if (t)
                if (r)
                    for (
                        o = o || s(n), f = f || s(h), u = 0, c = o.length;
                        u < c;
                        u++
                    )
                        wu(o[u], f[u]);
            ...
            return (
                0 < (f = s(h, "script")).length && di(f, !y && s(n, "script")),
                h
            );
        },
    ...
    i.fn.extend({
        ...
        empty: function () {
            for (var n, t = 0; null != (n = this[t]); t++)
                1 === n.nodeType &&
                    (i.cleanData(s(n, !1)), (n.textContent = ""));
            return this;
        },
        clone: function (n, t) {
            return (
    ...
    i.each(
        ...
        function (n, t) {
            i.fn[n] = function (n) {
                for (
                    var u, f = [], e = i(n), o = e.length - 1, r = 0;
                    r <= o;
                    r++
                )
        ...
        style: function (n, t, r, u) {
            if (n && 3 !== n.nodeType && 8 !== n.nodeType && n.style) {
                ...
                if (
                    ...
                    return o && "get" in o && void 0 !== (f = o.get(n, !1, u))
                        ? f
                        : s[t];
                "string" == (h = typeof r) &&
                    (f = kt.exec(r)) &&
    ...
    i.each(["height", "width"], function (n, t) {
        i.cssHooks[t] = {
            get: function (n, r, u) {
                if (r)
                    return !no.test(i.css(n, "display")) ||
                        (n.getClientRects().length &&
            ...
            select: {
                ...
                set: function (n, t) {
                    for (
                        ...
                        ((u = f[o]).selected =
                            -1 < i.inArray(i.valHooks.option.get(u), e)) &&
                            (r = !0);
        ...
        trigger: function (t, e, o, s) {
            ...
            if (
                ...
                3 !== o.nodeType &&
                    ...
                    ((t = t[i.expando]
                        ? t
                        : new i.Event(h, "object" == typeof t && t)).isTrigger =
                        s ? 2 : 3),
                    (t.namespace = b.join(".")),
                ...
                for (k = 0; (c = w[k++]) && !t.isPropagationStopped(); )
                    (p = c),
                        ...
                        (y =
                            (r.get(c, "events") || Object.create(null))[
                                t.type
                    ...
                    s ||
                        ...
                        (v &&
                            ...
                            t.isPropagationStopped() &&
                                p.addEventListener(h, or),
                            o[h](),
                            t.isPropagationStopped() &&
                                p.removeEventListener(h, or),
            ...
            ajax: function (t, r) {
                function b(t, r, f, c) {
                    ...
                    s ||
                        ...
                        (e.statusText = (r || l) + ""),
                        v
                            ? tt.resolveWith(h, [rt, l, e])
                            : tt.rejectWith(h, [e, l, b]),
                        e.statusCode(w),
                        (w = void 0),
                        y &&
                            nt.trigger(v ? "ajaxSuccess" : "ajaxError", [
                                e,
                                u,
                                v ? rt : b,
                            ]),
                ...
                u.ifModified &&
                    ...
                    i.etag[o] &&
                        e.setRequestHeader("If-None-Match", i.etag[o])),
            ...
            if (h || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    f.always(function () {
                        ...
                        t[e] &&
                            ((t.jsonpCallback = r.jsonpCallback), vr.push(e));
                        s && u(o) && o(s[0]);
                        s = o = void 0;
                    }),
                    "script"
                ...
                0 < e.length &&
                    i
                        ...
                        .done(function (n) {
                            ...
                            e.html(
                                f
                                    ? i("<div>").append(i.parseHTML(n)).find(f)
                                    : n
                            );
                        })
                        .always(
